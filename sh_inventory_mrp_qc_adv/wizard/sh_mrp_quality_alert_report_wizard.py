...
class MrpQualityAlertReport(models.AbstractModel):
    _name = 'report.sh_inventory_mrp_qc_adv.mrp_quality_alert_doc'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        quality_alert_dic = {}
        if data['operation_type'] == 'manufacturing':
                        ...
                        if search_alerts:
                            for alert in search_alerts:
                                alert_dic = {
                                    ...
                                    'mrp_id': alert.production_id.name,
...
class MrpQualityAlertReportWizard(models.TransientModel):
    ...
    def print_report(self):
        datas = self.read()[0]
        return self.env.ref('sh_inventory_mrp_qc_adv.mrp_report_quality_alert_action').report_action([], data=datas)
