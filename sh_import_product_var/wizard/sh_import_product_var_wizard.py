...
class import_product_var_wizard(models.TransientModel):
    ...
    filename = fields.Char('Private Key name', default='import_product_var_adv_csv')
                        ...
                        try:
                            ...
                            if row[0] not in (None,
                                ...
                                if row[0] != running_tmpl:
                                    ...
                                    elif row[4].strip() not in ("", False, None) and row[
                                        4].strip() == 'Storable Product' or row[4].strip() == 'Stockable Product':
